...
export const jobs: Job[] = [
  {
    ...
    fullDescription: [
      ...
      "This PhD is about building vision language models for the medical imaging domain. Not fine-tuning a pretrained model on a curated dataset and calling it a day. We mean training foundation models from scratch on real clinical data: 15 years of imaging and reports from LMU University Hospital, across CT, MRI, and PET/CT. Designing pretraining strategies that actually capture the relationship between what the image shows and what the report says. Building evaluation frameworks that go beyond leaderboard metrics. The project is called LYNX.",
